						...
						if(res.features.length > 0){
							...
							for(i=0;i<res.features.length;i++){
								...
								if(feature["id"].indexOf("place") > -1){
									...
									var $li = $("<li class='ez-mapbox-autocomplete-holder'><a href='#' title='" + place + "' class='ez-mapbox-autocomplete-item' data-location='" + [feature.text, country, shortcode ].join(";") + "' data-latlng='"+ feature.center.join(",") + "'><span><i class='fa fa-map-marker' aria-hidden='true'></i></span>" + placestring + "</a></li>");
